...
function VehiculosPage() {
  ...
  async function guardarVehiculo(
    ...
    try {
      ...
      const url = esEdicion
        ? `http://localhost:3000/api/vehiculos/${vehiculoEditando.id}`
        : "http://localhost:3000/api/vehiculos";
        ...
        >
          <div className="panel-header">
            <div>
              ...
              <p>
                {vehiculoEditando
                  ? `Actualiza la información de ${vehiculoEditando.marca} ${vehiculoEditando.modelo}.`
