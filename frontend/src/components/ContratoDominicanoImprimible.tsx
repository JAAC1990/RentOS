 ...
 * 10. Aislamiento CSS estricto (@media print) para imprimir exclusivamente 1 sola hoja limpia.
 */
  ...
  return (
    <div className="modal-overlay" style={{ overflowY: "auto", padding: "20px 10px", zIndex: 99999 }}>
      ...
      >
        ...
        {/* ================================================================= */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1.5px solid #1e3a8a", paddingBottom: "4px", marginBottom: "6px" }}>
          {/* Logo dinámico y Datos del Rent a Car */}
          <div style={{ maxWidth: "52%", display: "flex", gap: "8px", alignItems: "center" }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: "13px", fontWeight: 900, color: "#1e3a8a", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                {contrato.rentCar.nombre}
              </h1>
              <p style={{ margin: "1px 0 0 0", fontSize: "8px", color: "#334155" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <h2 style={{ margin: 0, fontSize: "13px", fontWeight: 900, color: "#1e3a8a", textTransform: "uppercase", borderBottom: "1px solid #1e3a8a", paddingBottom: "1px" }}>
              CONTRATO DEL VEHÍCULO
            </h2>
            <div style={{ marginTop: "2px", fontSize: "10px", fontWeight: 800, color: "#dc2626" }}>
          ...
          {/* Medidor Gráfico de Combustible */}
          <div style={{ textAlign: "right", minWidth: "110px" }}>
            <div style={{ border: "1px solid #94a3b8", borderRadius: "4px", padding: "3px 6px", backgroundColor: "#f8fafc", textAlign: "center" }}>
              <span style={{ fontSize: "7.5px", fontWeight: 800, color: "#1e3a8a", display: "block" }}>
                ⛽ COMBUSTIBLE (SALIDA)
              </span>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "8px", fontWeight: 700, margin: "1px 0" }}>
                <span>E</span>
                <div style={{ display: "flex", gap: "2px" }}>
                  <span style={{ width: "10px", height: "6px", backgroundColor: "#1e3a8a", borderRadius: "1px" }}></span>
                  <span style={{ width: "10px", height: "6px", backgroundColor: "#1e3a8a", borderRadius: "1px" }}></span>
                  <span style={{ width: "10px", height: "6px", backgroundColor: "#1e3a8a", borderRadius: "1px" }}></span>
                  <span style={{ width: "10px", height: "6px", backgroundColor: "#1e3a8a", borderRadius: "1px" }}></span>
                </div>
              ...
              <span style={{ fontSize: "8px", fontWeight: 800, color: "#0f172a" }}>
        ...
        {/* ================================================================= */}
        <div style={{ display: "grid", gridTemplateColumns: "1.18fr 0.82fr", gap: "8px", marginBottom: "6px" }}>
          {/* COLUMNA IZQUIERDA: DATOS CLIENTE + VEHÍCULO + FECHAS */}
          <div>
            {/* Tabla Datos del Cliente */}
            <div style={{ border: "1px solid #1e3a8a", borderRadius: "3px", overflow: "hidden", marginBottom: "5px" }}>
              <div style={{ backgroundColor: "#1e3a8a", color: "white", padding: "2px 6px", fontWeight: 800, fontSize: "9px", textTransform: "uppercase" }}>
                Datos del Cliente
              </div>
              <div style={{ padding: "3px 6px", fontSize: "8.5px", display: "grid", gap: "2px" }}>
                <div style={{ borderBottom: "1px dotted #cbd5e1", paddingBottom: "1px" }}>
            ...
            <div style={{ border: "1px solid #1e3a8a", borderRadius: "3px", overflow: "hidden" }}>
              <div style={{ backgroundColor: "#1e3a8a", color: "white", padding: "2px 6px", fontWeight: 800, fontSize: "9px", textTransform: "uppercase" }}>
                Datos del Vehículo & Cobertura
              </div>
              <div style={{ padding: "3px 6px", fontSize: "8.5px", display: "grid", gap: "2px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1.4fr 0.8fr 0.8fr", borderBottom: "1px dotted #cbd5e1", paddingBottom: "1px" }}>
                ...
                <div style={{ borderBottom: "1px dotted #cbd5e1", paddingBottom: "1px" }}>
                  <b>No. Chasis / VIN:</b> <span style={{ fontFamily: "monospace", fontSize: "8px" }}>{contrato.vehiculo.vin || "VIN-847291048201"}</span>
                </div>

                {/* Tipo de Seguro (Checkboxes) */}
                <div style={{ display: "flex", alignItems: "center", gap: "12px", padding: "1px 0", borderBottom: "1px dotted #cbd5e1" }}>
                  <b style={{ minWidth: "65px" }}>Tipo Seguro:</b>
                  <label style={{ display: "flex", alignItems: "center", gap: "3px" }}>
                    <input type="checkbox" checked={tipoSeguroActual.includes("COVER") || tipoSeguroActual === "FULL_COVER"} readOnly style={{ width: "9px", height: "9px", margin: 0 }} /> Full Cover
                  </label>
                  <label style={{ display: "flex", alignItems: "center", gap: "3px" }}>
                    <input type="checkbox" checked={tipoSeguroActual === "FULL"} readOnly style={{ width: "9px", height: "9px", margin: 0 }} /> Full
                  </label>
                  <label style={{ display: "flex", alignItems: "center", gap: "3px" }}>
                    <input type="checkbox" checked={tipoSeguroActual === "LEY" || tipoSeguroActual === "DE_LEY"} readOnly style={{ width: "9px", height: "9px", margin: 0 }} /> De Ley
                  </label>
                </div>

                {/* Odómetros y Días */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderBottom: "1px dotted #cbd5e1", paddingBottom: "1px" }}>
          ...
          <div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8px", marginBottom: "3px", border: "1px solid #1e3a8a" }}>
              <thead>
                <tr style={{ backgroundColor: "#1e3a8a", color: "white" }}>
                  <th style={{ padding: "2px 3px", textAlign: "left" }}>Concepto</th>
                  <th style={{ padding: "2px 3px", textAlign: "right", width: "45px" }}>RD$</th>
                  <th style={{ padding: "2px 3px", textAlign: "right", width: "45px" }}>US$</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                  <td style={{ padding: "1px 3px" }}>Precio x Día ({cantDias} d)</td>
                  <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? (tarifaDiaNum * cantDias).toLocaleString() : "-"}</td>
                  <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? (tarifaDiaNum * cantDias).toFixed(2) : "-"}</td>
                </tr>
                {precioHoraNum > 0 && (
                  <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                    <td style={{ padding: "1px 3px" }}>Precio x Hora Extra</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? precioHoraNum.toLocaleString() : "-"}</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? precioHoraNum.toFixed(2) : "-"}</td>
                  </tr>
                )}
                {cobrosExtraNum > 0 && (
                  <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                    <td style={{ padding: "1px 3px" }}>Cobros Extra / Servicios</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? cobrosExtraNum.toLocaleString() : "-"}</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? cobrosExtraNum.toFixed(2) : "-"}</td>
                  </tr>
                )}
                <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                  <td style={{ padding: "1px 3px" }}>Depósito en Garantía</td>
                  <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? depositoNum.toLocaleString() : "-"}</td>
                  <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? depositoNum.toFixed(2) : "-"}</td>
                </tr>
                {deliveryNum > 0 && (
                  <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                    <td style={{ padding: "1px 3px" }}>Delivery / Aeropuerto</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? deliveryNum.toLocaleString() : "-"}</td>
                    <td style={{ padding: "1px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? deliveryNum.toFixed(2) : "-"}</td>
                  </tr>
                )}
                <tr style={{ backgroundColor: "#f1f5f9", fontWeight: 800, borderTop: "1px solid #1e3a8a" }}>
                  <td style={{ padding: "2px 3px" }}>Total Liquidado</td>
                  <td style={{ padding: "2px 3px", textAlign: "right" }}>{monedaSigno === "RD$" ? `RD$ ${totalGeneral.toLocaleString()}` : "-"}</td>
                  <td style={{ padding: "2px 3px", textAlign: "right" }}>{monedaSigno === "US$" ? `US$ ${totalGeneral.toFixed(2)}` : "-"}</td>
                </tr>
              </tbody>
            </table>
            <div style={{ fontSize: "7px", color: "#b91c1c", fontWeight: 700, marginBottom: "2px" }}>
              * NOTA: LA GASOLINA DEJADA EN EL VEHÍCULO NO ES REEMBOLSABLE.
            </div>

            {/* Diagrama 360° del Vehículo */}
            <div style={{ border: "1px solid #cbd5e1", borderRadius: "3px", padding: "2px 4px", backgroundColor: "#f8fafc", textAlign: "center", marginBottom: "3px" }}>
              <div style={{ fontSize: "7.5px", fontWeight: 800, color: "#1e3a8a" }}>
                DIAGRAMA DE INSPECCIÓN 360° (DAÑOS)
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px", alignItems: "center", fontSize: "14px" }}>
                <div style={{ border: "1px dashed #cbd5e1", borderRadius: "2px", padding: "1px" }}>🚗 Front | Back 🚙</div>
                <div style={{ border: "1px dashed #cbd5e1", borderRadius: "2px", padding: "1px" }}>🚘 Left | Right 🚘</div>
              </div>
              <div style={{ fontSize: "6.5px", color: "#64748b" }}>
                {contrato.entrega?.defectos && contrato.entrega.defectos.length > 0
                  ? `🔴 ${contrato.entrega.defectos.length} daño(s) previo(s) detectado(s).`
                  : "🟢 Vehículo entregado en óptimas condiciones físicas."}
              </div>
            </div>

            {/* Checklist de 24 Accesorios */}
            <div style={{ border: "1px solid #cbd5e1", borderRadius: "3px", padding: "2px 4px", backgroundColor: "#ffffff" }}>
              <div style={{ fontSize: "7.5px", fontWeight: 800, color: "#1e3a8a", borderBottom: "1px solid #cbd5e1", paddingBottom: "1px", marginBottom: "2px" }}>
                CHECKLIST DE ACCESORIOS & EQUIPAMIENTO
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1px 2px", fontSize: "6.8px" }}>
                {Object.entries(checklistActual).map(([item, valor]) => (
                  <label key={item} style={{ display: "flex", alignItems: "center", gap: "2px", whiteSpace: "nowrap" }}>
                    <input type="checkbox" checked={valor} readOnly style={{ width: "8px", height: "8px", margin: 0 }} />
        ...
        {/* ================================================================= */}
        <div style={{ borderTop: "1px solid #1e3a8a", paddingTop: "3px", marginBottom: "4px" }}>
          {contrato.rentCar.tipoPlantillaContrato === "PERSONALIZADA" && contrato.rentCar.clausulasPersonalizadas ? (
            <div style={{ fontSize: "6.8px", textAlign: "justify", lineHeight: "1.15", color: "#334155", whiteSpace: "pre-line" }}>
              {contrato.rentCar.clausulasPersonalizadas}
            </div>
          ) : (
            <div style={{ fontSize: "6.5px", textAlign: "justify", lineHeight: "1.12", color: "#334155" }}>
        ...
        {/* ================================================================= */}
        <div style={{ display: "grid", gridTemplateColumns: "90px 1fr 1fr", gap: "8px", alignItems: "flex-end", borderTop: "1px solid #cbd5e1", paddingTop: "4px" }}>
          {/* Código QR de Verificación de Autenticidad */}
          <div style={{ textAlign: "center", borderRight: "1px solid #cbd5e1", paddingRight: "6px" }}>
            {qrDataUrl ? (
              <img src={qrDataUrl} alt="QR Verificación" style={{ width: "65px", height: "65px", display: "block", margin: "0 auto" }} />
            ) : (
              <div style={{ width: "65px", height: "65px", backgroundColor: "#f1f5f9", margin: "0 auto" }}></div>
            )}
            <span style={{ fontSize: "6.5px", fontWeight: 800, color: "#1e3a8a", display: "block", marginTop: "1px" }}>
              🛡️ VERIFICACIÓN QR
            </span>
            <span style={{ fontSize: "5.8px", color: "#64748b", display: "block" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ height: "36px", display: "flex", alignItems: "flex-end", justifyContent: "center", marginBottom: "1px" }}>
              {contrato.firmaArrendador ? (
                <img src={contrato.firmaArrendador} alt="Firma Inspector" style={{ maxHeight: "32px", maxWidth: "120px" }} />
              ) : (
                <div style={{ fontSize: "8px", color: "#94a3b8", fontStyle: "italic" }}>[Firma Inspector]</div>
              )}
            </div>
            <div style={{ borderTop: "1px solid #0f172a", paddingTop: "1px" }}>
              <b style={{ fontSize: "8px", textTransform: "uppercase", display: "block" }}>RECIBO CONFORME</b>
              <span style={{ fontSize: "7px", color: "#475569" }}>{contrato.rentCar.nombre}</span>
            </div>
          </div>
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ height: "36px", display: "flex", alignItems: "flex-end", justifyContent: "center", marginBottom: "1px" }}>
              {contrato.firmaCliente ? (
                <img src={contrato.firmaCliente} alt="Firma Cliente" style={{ maxHeight: "32px", maxWidth: "120px" }} />
              ) : (
                <div style={{ fontSize: "8px", color: "#94a3b8", fontStyle: "italic" }}>[Firma del Arrendatario]</div>
              )}
            </div>
            <div style={{ borderTop: "1px solid #0f172a", paddingTop: "1px" }}>
              <b style={{ fontSize: "8px", textTransform: "uppercase", display: "block" }}>ARRENDATARIO</b>
              <span style={{ fontSize: "7px", color: "#475569" }}>{contrato.cliente.nombre} {contrato.cliente.apellido}</span>
            </div>
          </div>
        </div>

        {/* Bloque Notarial Inferior */}
        <div style={{ marginTop: "4px", paddingTop: "2px", borderTop: "0.5px dotted #94a3b8", fontSize: "6px", color: "#64748b", textAlign: "justify" }}>
