...
\restrict q2dsS6fzPnGuhLHx51iThqRRLfz5cP4dFqTQ9D336J9LENFUB27Dmw5qG8CnD5s
...
CREATE TABLE public."Mantenimiento" (
    ...
    "kilometrajeServicio" integer NOT NULL,
    "proximoKilometraje" integer,
    "fechaServicio" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    taller text,
    estado public."EstadoMantenimiento" DEFAULT 'COMPLETADO'::public."EstadoMantenimiento" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL
);
...
CREATE TABLE public."RentCar" (
    ...
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "cargoKmExtra" numeric(10,2) DEFAULT 0.25,
    "depositoEstandar" numeric(10,2) DEFAULT 200.00,
    "limiteKilometrajeDiario" integer DEFAULT 200,
    moneda text DEFAULT 'USD'::text NOT NULL,
    "terminosContrato" text
);
...
--
-- Name: UbicacionGPS; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."UbicacionGPS" (
    id integer NOT NULL,
    "vehiculoId" integer NOT NULL,
    latitud double precision NOT NULL,
    longitud double precision NOT NULL,
    velocidad double precision DEFAULT 0.0 NOT NULL,
    rumbo double precision,
    "nivelBateria" double precision DEFAULT 100.0,
    ignicion boolean DEFAULT false NOT NULL,
    "bloqueoMotor" boolean DEFAULT false NOT NULL,
    geocerca text DEFAULT 'Zona Urbana Principal'::text,
    "direccionAprox" text,
    "fechaHora" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE public."UbicacionGPS" OWNER TO postgres;

--
-- Name: UbicacionGPS_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."UbicacionGPS_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."UbicacionGPS_id_seq" OWNER TO postgres;

--
-- Name: UbicacionGPS_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."UbicacionGPS_id_seq" OWNED BY public."UbicacionGPS".id;
...
--
-- Name: UbicacionGPS id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UbicacionGPS" ALTER COLUMN id SET DEFAULT nextval('public."UbicacionGPS_id_seq"'::regclass);
...
COPY public."Mantenimiento" (id, "rentCarId", "vehiculoId", "tipoServicio", descripcion, costo, "kilometrajeServicio", "proximoKilometraje", "fechaServicio", taller, estado, "createdAt", "updatedAt") FROM stdin;
1	1	1	Cambio de Aceite Sint�tico 5W-30 y Filtro	Filtro de aceite OEM + 4.5 cuartos Full Sint�tico	75.00	15450	20450	2026-08-23 02:38:26.559	Taller Central Santo Domingo	COMPLETADO	2026-08-23 02:38:26.568	2026-08-23 02:38:26.568
\.
...
COPY public."RentCar" (id, nombre, rnc, telefono, email, direccion, ciudad, "logoUrl", activo, "createdAt", "updatedAt", "cargoKmExtra", "depositoEstandar", "limiteKilometrajeDiario", moneda, "terminosContrato") FROM stdin;
1	RentOS Principal - Santo Domingo	132-00000-1	809-555-0199	contacto@rentos.do	Av. 27 de Febrero #100, Santo Domingo	Santo Domingo	\N	t	2026-08-22 22:08:52.335	2026-08-22 22:08:52.335	0.25	200.00	200	USD	\N
2	AutoRent Bávaro	132-99999-2	809-555-0200	contacto@autorentbavaro.do	\N	Punta Cana / Bávaro	\N	t	2026-08-23 02:10:09.015	2026-08-23 02:10:09.015	0.25	200.00	200	USD	\N
\.


--
-- Data for Name: UbicacionGPS; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."UbicacionGPS" (id, "vehiculoId", latitud, longitud, velocidad, rumbo, "nivelBateria", ignicion, "bloqueoMotor", geocerca, "direccionAprox", "fechaHora") FROM stdin;
1	1	18.47186	-69.93922	42.5	85	96.5	t	f	Zona Central DN	Av. Winston Churchill, Piantini, Santo Domingo	2026-08-23 02:41:50.948
2	4	18.48605	-69.93121	15.2	1	96.5	t	f	Zona Central DN	Av. John F. Kennedy / Ensanche Naco, DN	2026-08-23 02:41:50.95
3	8	19.45171	-70.69703	0	6	96.5	f	f	Región Norte - Santiago	Monumento a los Héroes, Santiago de los Caballeros	2026-08-23 02:41:50.95
4	9	18.56012	-68.37254	0	268	96.5	f	f	Zona Turística Este	Boulevard Turístico del Este, Bávaro / Punta Cana	2026-08-23 02:41:50.95
5	2	18.46824	-69.91032	0	113	96.5	f	f	Zona Central DN	Av. Máximo Gómez / Gazcue, Santo Domingo	2026-08-23 02:41:50.949
6	3	18.42971	-69.67568	0	37	96.5	f	f	Aeropuerto AILA	Aeropuerto Internacional de Las Américas (AILA)	2026-08-23 02:41:50.949
7	10	18.44892	-69.95931	0	110	96.5	f	f	Mirador Sur	Av. Anacaona / Mirador Sur, Santo Domingo	2026-08-23 02:41:50.95
8	11	18.47641	-69.88562	0	160	96.5	f	f	Zona Colonial	Zona Colonial, Santo Domingo	2026-08-23 02:41:50.95
9	1	18.47366765411589	-69.94071234560342	47	\N	95	t	f	Zona Central DN	Av. Winston Churchill, Piantini, Santo Domingo	2026-08-23 02:42:50.845
10	1	18.475945873238697	-69.94149666348996	56	\N	95	t	f	Zona Central DN	Av. Winston Churchill, Piantini, Santo Domingo	2026-08-23 02:42:52.954
11	1	18.475528506731294	-69.94275163950137	26	\N	95	t	f	Zona Central DN	Av. Winston Churchill, Piantini, Santo Domingo	2026-08-23 02:42:53.905
\.
...
2	Juan P�rez (Asesor)	juan@rentos.do	$2b$10$eG9Ov4f0d30iqB1ywpoXS.eVfn4AaKPIf7jYXa046rjkXw174GTfy	t	2026-08-23 02:44:56.612	2026-08-23 02:44:56.612	1	EMPLEADO
\.
...
--
-- Name: UbicacionGPS_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."UbicacionGPS_id_seq"', 11, true);
...
--
-- Name: UbicacionGPS UbicacionGPS_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UbicacionGPS"
    ADD CONSTRAINT "UbicacionGPS_pkey" PRIMARY KEY (id);
...
--
-- Name: Mantenimiento_rentCarId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Mantenimiento_rentCarId_idx" ON public."Mantenimiento" USING btree ("rentCarId");


--
-- Name: Mantenimiento_vehiculoId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Mantenimiento_vehiculoId_idx" ON public."Mantenimiento" USING btree ("vehiculoId");
...
--
-- Name: UbicacionGPS_fechaHora_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "UbicacionGPS_fechaHora_idx" ON public."UbicacionGPS" USING btree ("fechaHora");


--
-- Name: UbicacionGPS_vehiculoId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "UbicacionGPS_vehiculoId_idx" ON public."UbicacionGPS" USING btree ("vehiculoId");
...
--
-- Name: Mantenimiento Mantenimiento_rentCarId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Mantenimiento"
    ADD CONSTRAINT "Mantenimiento_rentCarId_fkey" FOREIGN KEY ("rentCarId") REFERENCES public."RentCar"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Mantenimiento Mantenimiento_vehiculoId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Mantenimiento"
    ADD CONSTRAINT "Mantenimiento_vehiculoId_fkey" FOREIGN KEY ("vehiculoId") REFERENCES public."Vehiculo"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: UbicacionGPS UbicacionGPS_vehiculoId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UbicacionGPS"
    ADD CONSTRAINT "UbicacionGPS_vehiculoId_fkey" FOREIGN KEY ("vehiculoId") REFERENCES public."Vehiculo"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict q2dsS6fzPnGuhLHx51iThqRRLfz5cP4dFqTQ9D336J9LENFUB27Dmw5qG8CnD5s
